...
using WalletWasabi.IntegrationTests.BitcoinCore.Configuration;
...
public class BitcoindRpcProcessBridge
{
	...
	public async Task StartAsync(CancellationToken cancel)
	{
		...
		string processPath = BundledAppHelpers.GetBinaryPath(BundledApp.Bitcoind);
	...
	public async Task StopAsync(bool onlyOwned)
	{
		...
		if (pid is not null && (!onlyOwned || CachedPid == pid))
		{
