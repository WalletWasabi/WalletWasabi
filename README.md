...
2. Get .NET Core 3.0 SDKs: https://www.microsoft.com/net/download

Note that you can disable .NET's telemetry by typing `export DOTNET_CLI_TELEMETRY_OPTOUT=1` on Linux and OSX or `set DOTNET_CLI_TELEMETRY_OPTOUT=1` on Windows, `setx DOTNET_CLI_TELEMETRY_OPTOUT 1` to disable it permanently on Windows.
