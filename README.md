...
[Wasabi](https://wasabiwallet.io) is an open-source, non-custodial, privacy-focused Bitcoin wallet, that implements trustless coin shuffling with mathematically provable anonymity - [ZeroLink CoinJoin](https://github.com/nopara73/zerolink).

The main privacy features are on the network level:
- Tor-only by default,
