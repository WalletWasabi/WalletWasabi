...
For step by step instructions of PGP verification and package instalation, see the [documentation](https://docs.wasabiwallet.io/using-wasabi/InstallPackage.html)
