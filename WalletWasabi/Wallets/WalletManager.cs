...
namespace WalletWasabi.Wallets
{
	public class WalletManager
	{
		...
		private FeeProvider FeeProvider { get; set; }
		...
		public void RegisterServices(BitcoinStore bitcoinStore, WasabiSynchronizer synchronizer, ServiceConfiguration serviceConfiguration, FeeProvider feeProvider, IBlockProvider blockProvider)
		{
