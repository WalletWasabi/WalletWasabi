...
namespace WalletWasabi.Wallets
{
	public class Wallet : BackgroundService
	{
			...
			IPayjoinClient? payjoinClient = null)
		{
			...
			return builder.BuildTransaction(
				...
				feeRateFetcher: () =>
				{
					...
					{
						return FeeProvider.BestFeeEstimates?.GetFeeRate(feeStrategy.Target) ?? throw new InvalidOperationException("Cannot get fee estimations.");
					}
		...
		public static Wallet CreateAndRegisterServices(Network network, BitcoinStore bitcoinStore, KeyManager keyManager, WasabiSynchronizer synchronizer, string dataDir, ServiceConfiguration serviceConfiguration, FeeProvider feeProvider, IBlockProvider blockProvider)
		{
