...
namespace WalletWasabi.Services
{
    public class IndexDownloader
    {
		...
		public static FilterModel GetStartingFilter(Network network)
		{
			...
			{
				return FilterModel.FromLine("0000000000000000001c8018d9cb3b742ef25114f27563e3fc4a1902167f9893:0211288322B003", GetStartingHeight(network));
			}
			else if (network == Network.TestNet)
			{
				return FilterModel.FromLine("00000000000f0d5edcaeba823db17f366be49a80d91d15b77747c2e017b8c20a:016E081E", GetStartingHeight(network));
			}
