...
namespace Gma.QrCodeNet.Encoding.DataEncodation
{
	...
	internal class AlphanumericEncoder : EncoderBase
	{
		...
		internal override Mode Mode => Mode.Alphanumeric;
		...
		protected override int GetBitCountInCharCountIndicator(int version) => CharCountIndicatorTable.GetBitCountInCharCountIndicator(Mode.Alphanumeric, version);
