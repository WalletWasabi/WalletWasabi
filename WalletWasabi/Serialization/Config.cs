	...
	public static JsonNode AnnouncerConfig(AnnouncerConfig cfg) =>
		...
		public static JsonNode WabiSabiConfig(WabiSabiConfig cfg) =>
		    Object([
		        ...
		        ("MinInputCountByRound", Int(cfg.MinInputCountByRound)),
		        ("MinInputCountByBlameRoundMultiplier", Double(cfg.MinInputCountByBlameRoundMultiplier)),
		        ("MinInputCountByBlameRound", Int(cfg.MinInputCountByBlameRound)),
		        ...
		        ("AllowedInputTypes", ScriptTypes(cfg.AllowedInputTypes)),
		        ("AllowedOutputTypes", ScriptTypes(cfg.AllowedOutputTypes))
		    ]);
