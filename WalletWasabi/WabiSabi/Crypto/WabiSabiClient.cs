...
namespace WalletWasabi.WabiSabi.Crypto
{
	...
	public class WabiSabiClient
	{
		public WabiSabiClient(
			...
			ulong maxAmount,
			int numberOfCredentials = CredentialIssuer.CredentialsPerRequest)
		{
			MaxAmount = maxAmount;
			...
			NumberOfCredentials = Guard.InRangeAndNotNull(nameof(numberOfCredentials), numberOfCredentials, 1, 3);
