...
public class CoinJoinTrackerFactory
{
	...
	public async Task<CoinJoinTracker> CreateAndStartAsync(IWallet wallet, int bestHeight, CoinRefrigerator coinRefrigerator, bool stopWhenAllMixed, bool overridePlebStop)
	{
