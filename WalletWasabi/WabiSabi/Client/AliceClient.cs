		...
		)
	{
		...
		catch (OperationCanceledException)
		{
			if (aliceClient is { })
			{
				...
				var unregisteringCancellationToken = confirmationCancellationToken;
				await aliceClient.TryToUnregisterAlicesAsync(unregisteringCancellationToken).ConfigureAwait(false);
			}
