...
public class CoinJoinTrackerFactory
{
	...
	public async Task<CoinJoinTracker> CreateAndStartAsync(Wallet wallet, Wallet outputWallet, Func<Task<IEnumerable<SmartCoin>>> coinCandidatesFunc, bool isAutoCoinJoinDisabled, bool overridePlebStop)
	{
		...
		return new CoinJoinTracker(wallet, coinJoinClient, coinCandidatesFunc, isAutoCoinJoinDisabled, overridePlebStop, outputWallet, _cancellationToken);
	}
}
