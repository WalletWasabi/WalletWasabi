...
public class RuntimeParams
{
	...
	public async Task SaveAsync()
	{
		try
		{
			using (await _asyncLock.LockAsync())
			{
				...
				string jsonString = Encode.RuntimeParams(this).ToJsonString(new JsonSerializerOptions {WriteIndented = true});
	...
	public static async Task LoadAsync()
	{
		try
		{
			...
			InternalInstance = Decode.FromString(jsonString, Decode.RuntimeParams)
