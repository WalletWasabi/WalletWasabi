...
namespace NBitcoin.RPC
{
	public static class RPCClientExtensions
	{
		...
		/// </summary>
		/// <param name="timeout">Time in milliseconds to wait for a response. (int, optional, default=0). 0 indicates no timeout.</param>
		...
		/// <returns>Return (Allowed, reject-reason)</returns>
