...
namespace WalletWasabi.Blockchain.TransactionBroadcasting
{
	public class TransactionBroadcaster
	{
		...
		public IEnumerable<WalletService> AliveWalletServices => WalletManager.GetWalletServices().Where(x => x != null && !x.IsStoppingOrStopped);
		public RPCClient RpcClient { get; private set; }
		public WalletManager WalletManager { get; }

		public TransactionBroadcaster(Network network, BitcoinStore bitcoinStore, WasabiSynchronizer synchronizer, NodesGroup nodes, RPCClient rpc, WalletManager walletManager)
		{
