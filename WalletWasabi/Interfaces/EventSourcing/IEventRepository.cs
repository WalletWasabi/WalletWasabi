...
public interface IEventRepository
{
	...
	/// command should be retried with freshly loaded events from <see cref="GetEventsAsync"/>.
	/// </summary>
	...
	public Task AppendEventsAsync(string aggregateType, string aggregateId, IEnumerable<WrappedEvent> wrappedEvents);
	...
	/// <param name="aggregateType">Type of aggregate</param>
	/// <param name="aggregateId">ID of aggregate</param>
	/// <param name="afterSequenceId">Starts with event after given <seealso cref="WrappedEvent.SequenceId"/> and lists all following events</param>
	...
	/// </summary>
	/// <param name="aggregateType">Type of aggregate</param>
	/// <param name="afterAggregateId">Starts with id right after given ID and lists all following IDs in any artificial order</param>
	/// <param name="maxCount">Limits the number of returned events</param>
