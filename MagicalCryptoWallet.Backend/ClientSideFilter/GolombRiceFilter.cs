...
namespace MagicalCryptoWallet.Backend
{
	...
	public class GolombRiceFilter
	{
		...
		public GolombRiceFilter(FastBitArray data, byte P, int N)
		{
			this.P = P;
			this.N = N;
		...
		public static GolombRiceFilter Build(byte[] k, byte P, IEnumerable<byte[]> data)
		{
			if (P == 0x00)
			...
			return new GolombRiceFilter(filterData, P, N);
		}
