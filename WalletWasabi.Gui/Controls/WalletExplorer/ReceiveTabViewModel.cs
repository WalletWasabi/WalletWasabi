...
namespace WalletWasabi.Gui.Controls.WalletExplorer
{
	public class ReceiveTabViewModel : WalletActionViewModel
	{
		...
		public override void OnOpen()
		{
			...
			Observable
				.FromEventPattern(Global.DefaultWalletService.TransactionProcessor, nameof(Global.DefaultWalletService.TransactionProcessor.WalletRelevantTransactionProcessed))
