...
namespace WalletWasabi.Gui.Controls.WalletExplorer
{
	public class ReceiveTabViewModel : WalletActionViewModel
	{
		...
		public override void OnOpen()
		{
			...
			Observable
				.FromEventPattern(Wallet.Wallet.WalletService.TransactionProcessor, nameof(Wallet.Wallet.WalletService.TransactionProcessor.WalletRelevantTransactionProcessed))
