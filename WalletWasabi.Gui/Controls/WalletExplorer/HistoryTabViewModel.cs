...
namespace WalletWasabi.Gui.Controls.WalletExplorer
{
	public class HistoryTabViewModel : WalletActionViewModel
	{
		...
		public override void OnOpen()
		{
			...
			Observable.FromEventPattern(Wallet.WalletService, nameof(Wallet.WalletService.NewBlockProcessed))
				.Merge(Observable.FromEventPattern(Wallet.WalletService.TransactionProcessor, nameof(Wallet.WalletService.TransactionProcessor.WalletRelevantTransactionProcessed)))
		...
		private async Task TryRewriteTableAsync()
		{
			try
			{
				var historyBuilder = new TransactionHistoryBuilder(Wallet.WalletService);
