...
namespace WalletWasabi.Gui.Controls.WalletExplorer
{
	public class HistoryTabViewModel : WalletActionViewModel
	{
		...
		public override void OnOpen()
		{
			...
			Observable.FromEventPattern(Global.DefaultWalletService, nameof(Global.DefaultWalletService.NewBlockProcessed))
				.Merge(Observable.FromEventPattern(Global.DefaultWalletService.TransactionProcessor, nameof(Global.DefaultWalletService.TransactionProcessor.WalletRelevantTransactionProcessed)))
		...
		private async Task TryRewriteTableAsync()
		{
			try
			{
				var historyBuilder = new TransactionHistoryBuilder(Global.DefaultWalletService);
