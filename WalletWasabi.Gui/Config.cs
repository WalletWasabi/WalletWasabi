...
namespace WalletWasabi.Gui
{
    ...
    public class Config : IConfig
    {
        ...
        public static bool TryParseEndpoint(string str, int defaultPort, out EndPoint endPoint)
        {
            ...
            str = str.Trim();
            if (!Utils.TryParseEndpoint(str, defaultPort, out endPoint))
            {
...
#pragma warning restore CS0612 // Type or member is obsolete
        ...
        private void MigrateBackwardCompatiblePortField(Func<int?> getPort, Action<int> setPort, Func<string> getHost, Action<string> setHost, Network network)
        {
