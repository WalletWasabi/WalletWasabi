...
namespace WalletWasabi.Gui.ViewModels
{
	...
	public class StatusBarViewModel : ViewModelBase
	{
		...
		{
			// Set peers to 0 if Tor is not running, because we get Tor status from backend answer so it is seem to the user that peers are connected over clearnet, while they do not.
