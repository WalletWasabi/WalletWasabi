...
public class Global
{
	...
	private void RegisterCoinJoinComponents()
	{
		...
		HostedServices.Register<CoinJoinManager>(() => new CoinJoinManager(WalletManager, HostedServices.Get<RoundStateUpdater>(), CoordinatorHttpClientFactory, Synchronizer, Config.CoordinatorIdentifier, PrisonClient), "CoinJoin Manager");
	}
