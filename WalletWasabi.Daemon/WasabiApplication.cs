	...
	private void MigrateConfigFiles()
	{
		...
		if (persistentConfig is PersistentConfigPrev2_6_0 oldConfig)
		{
			...
			var mainConfig = new PersistentConfig(
				...
				BitcoinRpcUri : oldConfig.MainNetBitcoinRpcEndPoint.ToEndpointString(),
				ConfigVersion : 3,
			...
			var testConfig = mainConfig with
			{
				...
				BitcoinRpcUri = oldConfig.TestNetBitcoinRpcEndPoint.ToEndpointString(),
			};
			...
			var regtestConfig = mainConfig with
			{
				...
				BitcoinRpcUri = oldConfig.RegTestBitcoinRpcEndPoint.ToEndpointString(),
			};
