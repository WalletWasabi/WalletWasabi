...
{ fetchNuGet }: [
  (fetchNuGet { pname = "Avalonia"; version = "11.2.6"; hash = "sha256-f+fuElhlc2dCUt/GD/Noh07JqPIA8ZtpFxdmetdPVVI="; })
  ...
  (fetchNuGet { pname = "Avalonia.Controls.ColorPicker"; version = "11.2.6"; hash = "sha256-TeUwMcNIvXw/gMuApUODZ7nuymM6OF9cNUGSajlyfoQ="; })
  (fetchNuGet { pname = "Avalonia.Controls.DataGrid"; version = "11.2.6"; hash = "sha256-69ZtybLdpGG28M6p1Cenz6PZEfdf1VKxA4wIrw5FJnI="; })
  (fetchNuGet { pname = "Avalonia.Controls.TreeDataGrid"; version = "11.1.1"; hash = "sha256-pEh7qGLhkirOW81xqy8iRMmFpOgdyTFpWpUHrkHgmcM="; })
  (fetchNuGet { pname = "Avalonia.Desktop"; version = "11.2.6"; hash = "sha256-PANuvQlAhDWjnv7VUzxOjz6XRmt4l/YKhVLSIP7YL24="; })
  (fetchNuGet { pname = "Avalonia.Diagnostics"; version = "11.2.6"; hash = "sha256-Lc9qLIywzD06I9sPXQRjLLLijDoFOVmuO5qNh301gYQ="; })
  (fetchNuGet { pname = "Avalonia.Fonts.Inter"; version = "11.2.6"; hash = "sha256-/FWIvrtDk6D8TO+fmgDPnV8KIOKHZVraxXafOGvwfhQ="; })
  (fetchNuGet { pname = "Avalonia.FreeDesktop"; version = "11.2.6"; hash = "sha256-816li4Nj8+oNkfeMjOAtFSFS+DSo9e2S3K45xqyHJAQ="; })
  (fetchNuGet { pname = "Avalonia.Headless"; version = "11.2.6"; hash = "sha256-sV68KaIcXu/IK7dQ8S6GdPtRNm6PaOTv5v+z4IUYp1E="; })
  (fetchNuGet { pname = "Avalonia.Headless.XUnit"; version = "11.2.6"; hash = "sha256-D/ZonRQip6kqpwGDHZVcKSKs+c4fsYcp0nHHz9ZGTtM="; })
  (fetchNuGet { pname = "Avalonia.Native"; version = "11.2.6"; hash = "sha256-by589X1UIjeQNK0lJMLfNzF2dK+qTNT6CBJNLgG86Aw="; })
  (fetchNuGet { pname = "Avalonia.ReactiveUI"; version = "11.2.6"; hash = "sha256-DsUxdEQMgpmzgRS5zkf3rqk32YL3xFN7KoQkn1Xl6WU="; })
  (fetchNuGet { pname = "Avalonia.Remote.Protocol"; version = "11.2.6"; hash = "sha256-Q2uPnR6tPFWExohhMJKnJGTet8IVpQn/HIcRurUPAHQ="; })
  (fetchNuGet { pname = "Avalonia.Skia"; version = "11.2.6"; hash = "sha256-6CfDcJT707iSB9XUQRvSvr5YWMavhiYPnHwVudUl74c="; })
  (fetchNuGet { pname = "Avalonia.Svg"; version = "11.0.0"; hash = "sha256-edKxg+OsZ2EkWvSDpGxRTLmEx3U1G0+6CbRJy4VUr/Y="; })
  (fetchNuGet { pname = "Avalonia.Themes.Fluent"; version = "11.2.6"; hash = "sha256-L664hbpCtbu8aDX7YLnqKybF/eQFfes8eQp4A+as8PY="; })
  (fetchNuGet { pname = "Avalonia.Themes.Simple"; version = "11.2.6"; hash = "sha256-kE31/1tchMJ6XmEbjLr5Idc7uKBAbuhsroUMg0LQauA="; })
  (fetchNuGet { pname = "Avalonia.Win32"; version = "11.2.6"; hash = "sha256-e+DNtKz4UDNqOP1vvVRqbD67n5IG9PxmGkMz7B6b7AY="; })
  (fetchNuGet { pname = "Avalonia.X11"; version = "11.2.6"; hash = "sha256-atnfxY6vspMzvMFc9PzwWb/uPNkPx5tF3zDGKeqlGIw="; })
