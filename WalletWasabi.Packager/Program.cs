		...
		private static void Publish()
		{
			...
			foreach (string target in Targets)
			{
				...
				if (target.StartsWith("win"))
				{
					...
					// IF IT IS IN ONLYBINARIES MODE DON'T DO ANYTHING FANCY PACKAGING AFTER THIS!!!
					if (OnlyBinaries)
					{
...
";
				...
				else if (target.StartsWith("linux"))
				{
					...
					// License format does not yet work, but should work in the future, it is work in progress: https://bugs.launchpad.net/ubuntu/+source/software-center/+bug/435183
