...
Start-Process -FilePath 'C:\Program Files (x86)\Microsoft Visual Studio\2019\Community\Common7\IDE\devenv.com' -ArgumentList $arguments -Wait # If -NoNewWindow added devenv will hang forever at the end of the build.
