...
Wasabi automatically detects if it is running on Tails or Whonix and will use the already running system-wide Tor instance, instead of starting it's own.
