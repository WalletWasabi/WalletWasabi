...
namespace HiddenWallet.Daemon.App_Start
{
 ...
 //   {
	...
	//			.EnableSwagger(c =>
	//			{
	//				c.SingleApiVersion("v1", "HiddenWalletApi");
	//				c.IncludeXmlComments($@"{System.AppDomain.CurrentDomain.BaseDirectory}\bin\HiddenWalletApi.XML");
