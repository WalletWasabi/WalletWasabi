...
namespace WalletWasabi.Tests
{
	public class StoreTests
	{
		...
		public async Task IndexStoreTestsAsync()
		{
			...
			var dir = Path.Combine(Global.Instance.DataDir, "IndexStoreTestsAsync");
		...
		{
			var file1 = Path.Combine(Global.Instance.DataDir, "IoManagerTestsAsync", $"file1.dat");
			var file2 = Path.Combine(Global.Instance.DataDir, "IoManagerTestsAsync", $"file2.dat");
		...
		{
			var file = Path.Combine(Global.Instance.DataDir, "IoTestsAsync", $"file.dat");
