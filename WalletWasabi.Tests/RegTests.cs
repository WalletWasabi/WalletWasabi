...
namespace WalletWasabi.Tests
{
	...
	public class RegTests : IClassFixture<SharedFixture>
	{
		...
		public async Task WalletTestsAsync()
		{
			...
			WasabiClient wasabiClient = new WasabiClient(new Uri(RegTestFixture.BackendEndPoint));
		...
		public async Task CoinJoinMultipleRoundTestsAsync()
		{
			...
			WasabiClient wasabiClient2 = new WasabiClient(new Uri(RegTestFixture.BackendEndPoint));
