...
#pragma warning disable IDE0059 // Value assigned to symbol is never used
		...
		public async Task FilterBuilderTestAsync()
		{
			...
			var indexBuilderServiceDir = Path.Combine(Global.Instance.DataDir, "IndexBuilderService");
		...
		public async Task WalletTestsAsync()
		{
			...
			var workDir = Path.Combine(Global.Instance.DataDir, "WalletTestsAsync");
		...
		public async Task SendTestsAsync()
		{
			...
			var workDir = Path.Combine(Global.Instance.DataDir, "SendTestsAsync");
			var wallet = new WalletService(bitcoinStore, keyManager, synchronizer, chaumianClient, mempoolService, nodes, workDir, serviceConfiguration);
			wallet.NewFilterProcessed += Wallet_NewFilterProcessed;
		...
		public async Task BuildTransactionValidationsTestAsync()
		{
			...
			// 6. Create wallet service.
			var workDir = Path.Combine(Global.Instance.DataDir, "BuildTransactionValidationsTestAsync");
			var wallet = new WalletService(bitcoinStore, keyManager, synchronizer, chaumianClient, mempoolService, nodes, workDir, serviceConfiguration);
			wallet.NewFilterProcessed += Wallet_NewFilterProcessed;
		...
		public async Task BuildTransactionReorgsTestAsync()
		{
			...
			// 6. Create wallet service.
			var workDir = Path.Combine(Global.Instance.DataDir, "BuildTransactionReorgsTestAsync");
			var wallet = new WalletService(bitcoinStore, keyManager, synchronizer, chaumianClient, mempoolService, nodes, workDir, serviceConfiguration);
			wallet.NewFilterProcessed += Wallet_NewFilterProcessed;
		...
		public async Task SpendUnconfirmedTxTestAsync()
		{
			...
			// 6. Create wallet service.
			var workDir = Path.Combine(Global.Instance.DataDir, "SpendUnconfirmedTxTestAsync");
			var wallet = new WalletService(bitcoinStore, keyManager, synchronizer, chaumianClient, mempoolService, nodes, workDir, serviceConfiguration);
			wallet.NewFilterProcessed += Wallet_NewFilterProcessed;
		...
		public async Task ReplaceByFeeTxTestAsync()
		{
			...
			// 6. Create wallet service.
			var workDir = Path.Combine(Global.Instance.DataDir, "ReplaceByFeeTxTestAsync");
			var wallet = new WalletService(bitcoinStore, keyManager, synchronizer, chaumianClient, mempoolService, nodes, workDir, serviceConfiguration);
			wallet.NewFilterProcessed += Wallet_NewFilterProcessed;
		...
		public async Task CcjCoordinatorCtorTestsAsync()
		{
			...
			var folder = Path.Combine(Global.Instance.DataDir, "CcjCoordinatorCtorTestsAsync");
		...
		public async Task CoinJoinMultipleRoundTestsAsync()
		{
			...
			var indexFilePath2 = Path.Combine(Global.Instance.DataDir, "CoinJoinMultipleRoundTestsAsync", $"Index{network}2.dat");
			...
			// 6. Create wallet service.
			var workDir = Path.Combine(Global.Instance.DataDir, "CoinJoinMultipleRoundTestsAsync");
			var wallet = new WalletService(bitcoinStore, keyManager, synchronizer, chaumianClient, mempoolService, nodes, workDir, serviceConfiguration);
			wallet.NewFilterProcessed += Wallet_NewFilterProcessed;

			var workDir2 = Path.Combine(Global.Instance.DataDir, "CoinJoinMultipleRoundTestsAsync2");
