...
public class WalletTests : IClassFixture<RegTestFixture>
{
	...
	public async Task WalletTestsAsync()
	{
		...
		WalletFactory walletFactory = new(workDir, network, bitcoinStore, synchronizer, setup.ServiceConfiguration, feeProvider, blockDownloadService, cpfpInfoProvider);
