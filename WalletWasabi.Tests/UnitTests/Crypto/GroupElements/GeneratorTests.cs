...
namespace WalletWasabi.Tests.UnitTests.Crypto.GroupElements
{
	public class GeneratorTests
	{
		...
		public void GeneratorsArentChanged()
		{
			...
			Assert.Equal("034787C4A880CB54D4A13130E6A31BDEEB047FE9D67C558EAC3DE30CC3A66C277D", ByteHelpers.ToHex(GroupElement.Gg.ToBytes()));
			...
			Assert.Equal("03A456261F53BFC99BF0DB0D71FE3E1A259961D9DA896217DAC475841DA3A4F16C", ByteHelpers.ToHex(GroupElement.Gwp.ToBytes()));
			Assert.Equal("0381E7BCF60042263290325032954C500DCCE6D470A952C2FCDC62CF2280282D76", ByteHelpers.ToHex(GroupElement.Gx0.ToBytes()));
