...
namespace WalletWasabi.Tests.UnitTests.Crypto.GroupElements
{
	public class GeneratorTests
	{
		...
		public void GeneratorsArentChanged()
		{
			...
			Assert.Equal("032F7BF18F3EB9639FF9234D9B74C49E598E34BD3AF1CEEE7378E012E73E66ABAE", ByteHelpers.ToHex(Generators.Ga.ToBytes()));
			Assert.Equal("024787C4A880CB54D4A13130E6A31BDEEB047FE9D67C558EAC3DE30CC3A66C277D", ByteHelpers.ToHex(Generators.Gg.ToBytes()));
			Assert.Equal("035AF23B3B63E068D2D157513A77CD78BEC1B389EA5EDEC6C9A8DA1254C3DEAC03", ByteHelpers.ToHex(Generators.Gh.ToBytes()));
			Assert.Equal("031B786490B66B665F09AE2F848EFC1C2B8D86E35FCDCEF67F61CF5A95FC8C7263", ByteHelpers.ToHex(Generators.Gs.ToBytes()));
			Assert.Equal("0322C1EC0F8A3B41D1FB7184692428B0236E253AA643ACCBCF412CAE3231C14967", ByteHelpers.ToHex(Generators.GV.ToBytes()));
			Assert.Equal("0338A4AAE54CCB98207FA4707DB4F711A9427B0444F97FC8F54EF9D00E25013C2F", ByteHelpers.ToHex(Generators.Gw.ToBytes()));
			Assert.Equal("02A456261F53BFC99BF0DB0D71FE3E1A259961D9DA896217DAC475841DA3A4F16C", ByteHelpers.ToHex(Generators.Gwp.ToBytes()));
