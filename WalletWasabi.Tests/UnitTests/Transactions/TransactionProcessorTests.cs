...
public class TransactionProcessorTests
{
	...
	public async Task CanReceiveSilentPaymentAsync()
	{
		...
		var donationAddress = new SilentPaymentAddress(0, scanKey.PubKey, spendKey.PubKey);
		...
		tx0.Transaction.SetTweakData(tweakData.ToBytes());
		...
		Assert.Equal(KeyPath.Parse("m/353'/0'/0'/0/0"), silentPaymentCoin.HdPubKey.FullKeyPath);
		Assert.Equal("A, wasabi", silentPaymentCoin.HdPubKey.Cluster.ToString());
