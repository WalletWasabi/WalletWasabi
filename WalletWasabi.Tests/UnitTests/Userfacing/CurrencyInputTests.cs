...
public class CurrencyInputTests
{
	...
	private class BitcoinTestData : TheoryData<string, bool, string?>
	{
		public BitcoinTestData()
		{
			...
			Add("1.000000000", true, "1");
			Add("1.111111119", true, "1.11111112"); // Notice the value got rounded!
			...
			Add("20999999.976910000000000", true, "20999999.97691");
			Add("209999990000000000.97000000000069", true, "209999990000000000.97");
			Add("1.000000001", true, "1");
			Add("20999999.97000000000069", true, "20999999.97");
		}
	}
}
