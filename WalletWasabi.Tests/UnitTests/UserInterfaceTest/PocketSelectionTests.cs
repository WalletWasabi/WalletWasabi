...
// {
// 	private readonly Wallets.Wallet _wallet;
...
//
// 		_wallet = new Wallets.Wallet(Common.GetWorkDir(), Network.Main, km);
// 		var key = km.GenerateNewKey(SmartLabel.Empty, KeyState.Clean, false);
// 		_address = BitcoinAddress.Create("bc1q7v7qfhwx55erxkc66nsv39x4azwufvy6zq8ya4", Network.Main);
// 	}
//
// 	[Fact]
...
// 		};
//
// 		var selection = new LabelSelectionViewModel(_wallet, info, _address);
//
...
// 		selection = new LabelSelectionViewModel(_wallet, info, _address);
// 		selection.Reset(pockets.ToArray());
//
