...
public class SmartHeaderTests
{
	...
	{
		var startingMain = SmartHeader.GetStartingHeader(Network.Main, new[] { RpcPubkeyType.TxWitnessV0Keyhash, RpcPubkeyType.TxWitnessV1Taproot });
		var startingTest = SmartHeader.GetStartingHeader(Network.TestNet, new[] { RpcPubkeyType.TxWitnessV0Keyhash, RpcPubkeyType.TxWitnessV1Taproot });
		var startingReg = SmartHeader.GetStartingHeader(Network.RegTest, new[] { RpcPubkeyType.TxWitnessV0Keyhash, RpcPubkeyType.TxWitnessV1Taproot });
