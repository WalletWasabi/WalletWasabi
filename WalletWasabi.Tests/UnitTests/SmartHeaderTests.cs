...
public class SmartHeaderTests
{
	...
	{
		var startingMain = SmartHeader.GetStartingHeader(Network.Main, RpcPubkeyType.TxWitnessV0Keyhash);
		var startingTest = SmartHeader.GetStartingHeader(Network.TestNet, RpcPubkeyType.TxWitnessV0Keyhash);
		var startingReg = SmartHeader.GetStartingHeader(Network.RegTest, RpcPubkeyType.TxWitnessV0Keyhash);
