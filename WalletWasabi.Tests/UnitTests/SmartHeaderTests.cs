...
public class SmartHeaderTests
{
	...
	public void StartingHeaderTests()
	{
		...
		var expectedHeaderTest = new uint256("0000000000211a4d54bceb763ea690a4171a734c48d36f7d8e30b51d6df6ea85");
		...
		Assert.Equal(expectedHeaderMain, startingMain.Header);
		...
		Assert.Equal(expectedHeaderTest, startingTest.Header);
		...
		Assert.Equal(expectedHeaderReg, startingReg.Header);
