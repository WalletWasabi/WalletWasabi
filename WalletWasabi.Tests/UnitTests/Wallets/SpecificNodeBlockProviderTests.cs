...
public class SpecificNodeBlockProviderTests
{
	...
	public async Task NoRunningPeerAsync()
	{
		...
		ServiceConfiguration serviceConfiguration = new(bitcoinCoreEndPoint, dustThreshold: Money.Satoshis(1000), new Uri(WalletWasabi.Helpers.Constants.DefaultRegtestCoordinatorUri));
