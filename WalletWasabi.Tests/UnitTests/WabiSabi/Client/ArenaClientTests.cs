...
public class ArenaClientTests
{
	...
	public async Task SignTransactionAsync()
	{
		...
		await Assert.ThrowsAsync<ArgumentException>(async () =>
				await apiClient.SignTransactionAsync(round.Id, alice1.Coin, keyChain, keyChain.GetBitcoinSecret(alice1.Coin.ScriptPubKey), finalizedEmptyState.CreateUnsignedTransactionWithPrecomputedData(), CancellationToken.None));
		...
		await Assert.ThrowsAsync<InvalidOperationException>(async () =>
				await apiClient.SignTransactionAsync(round.Id, alice2.Coin, keyChain, keyChain.GetBitcoinSecret(alice2.Coin.ScriptPubKey), oneInput.CreateUnsignedTransactionWithPrecomputedData(), CancellationToken.None));
		...
		await apiClient.SignTransactionAsync(round.Id, alice1.Coin, keyChain, keyChain.GetBitcoinSecret(alice1.Coin.ScriptPubKey), unsigned, CancellationToken.None);
		...
		await apiClient.SignTransactionAsync(round.Id, alice2.Coin, keyChain, keyChain.GetBitcoinSecret(alice2.Coin.ScriptPubKey), unsigned, CancellationToken.None);
