...
public class SerializationTests
{
	...
	{
		var serializedMessage = Encode.CoordinatorMessage(message).ToJsonString();
		var deserializedMessage = Decode.CoordinatorMessage<T>(serializedMessage);
		var reserializedMessage = Encode.CoordinatorMessage(deserializedMessage).ToJsonString();
