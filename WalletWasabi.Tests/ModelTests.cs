...
namespace WalletWasabi.Tests
{
	public class ModelTests
	{
		...
		public void SmartCoinEquality()
		{
			...
			// If the txId or the index differs, equality should think it is a different coin.
			...
			// If the txId and the index is the same, equality should think it is the same coin.
