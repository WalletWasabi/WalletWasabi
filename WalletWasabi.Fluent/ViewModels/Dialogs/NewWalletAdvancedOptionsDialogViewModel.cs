	...
	public NewWalletAdvancedOptionsDialogViewModel(CoinJoinProfileViewModelBase currentProfile, bool isAutoCoinjoinEnabled)
	{
		...
		NextCommand = ReactiveCommand.Create(
			() =>
			{
				...
				Close(DialogResultKind.Normal, new Result(new ManualCoinJoinProfileDialogViewModel.ManualCoinJoinProfileDialogViewModelResult(new ManualCoinJoinProfileViewModel(target, isolateRed)), IsAutoCoinjoinEnabled));
			});
	}
