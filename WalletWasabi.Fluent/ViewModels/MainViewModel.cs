...
public partial class MainViewModel : ViewModelBase
{
	...
	private void RegisterViewModels()
	{
		...
		{
			if (UiServices.WalletManager.TryGetSelectedWalletViewModel(out var walletViewModel))
			{
		...
		{
			if (UiServices.WalletManager.TryGetSelectedWalletViewModel(out var walletViewModel) && !walletViewModel.IsWatchOnly)
			{
