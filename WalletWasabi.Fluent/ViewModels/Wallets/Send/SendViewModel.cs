...
public partial class SendViewModel : RoutableViewModel
{
	...
	public SendViewModel(WalletViewModel walletVm)
	{
		...
		Balance = new WalletBalanceTileViewModel(walletVm, showOnlyAvailable: true);
		...
		InsertMaxCommand = ReactiveCommand.Create(() => AmountBtc = _wallet.Coins.Available().TotalAmount().ToDecimal(MoneyUnit.BTC));
