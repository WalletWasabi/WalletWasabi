...
public partial class SendViewModel : RoutableViewModel
{
	...
	public SendViewModel(WalletViewModel walletVm, IObservable<Unit> balanceChanged, ObservableCollection<HistoryItemViewModelBase> history)
	{
		_to = "";
		...
		NextCommand = ReactiveCommand.CreateFromTask(async () =>
		{
			...
			Navigate().To(new TransactionPreviewViewModel(walletVm, _transactionInfo, address, _isFixedAmount));
