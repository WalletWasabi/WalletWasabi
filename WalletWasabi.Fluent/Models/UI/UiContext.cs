...
public class UiContext
{
	...
	public static UiContext Default => DefaultInstance ??= new UiContext(new QrGenerator(), new QrCodeReader(), ApplicationHelper.Clipboard ?? new NullClipboard(), CreateWalletListModel());
