	...
	private void Save()
	{
		RxApp.MainThreadScheduler.Schedule(
			() =>
			{
				try
				{
					PersistentConfig currenctConfig = ConfigManagerNg.LoadFile<PersistentConfig>(_persistentConfigFilePath);
					PersistentConfig newConfig = ApplyChanges(currenctConfig);
