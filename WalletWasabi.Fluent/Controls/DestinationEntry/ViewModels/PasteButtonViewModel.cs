...
public class PasteButtonViewModel : IDisposable
{
	...
	public PasteButtonViewModel(
		IObservable<string> incomingContent,
		IObservable<bool> isNewContentAvailable,
		IObservable<bool> isMainWindowActive)
	{
		HasNewContent = isMainWindowActive.CombineLatest(isNewContentAvailable, (isActive, hasNewContent) => isActive && hasNewContent);
