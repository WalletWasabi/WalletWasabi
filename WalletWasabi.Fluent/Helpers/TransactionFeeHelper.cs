...
public static class TransactionFeeHelper
{
	...
	public static bool TryEstimateConfirmationTime(FeeRateEstimationUpdater feeProvider, Network network, SmartTransaction tx, [NotNullWhen(true)] out TimeSpan? estimate)
	{
		estimate = null;
