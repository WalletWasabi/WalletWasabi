...
namespace MagicalCryptoWallet.Models
{
	...
	public class TxoRef : IEquatable<TxoRef>, IEquatable<OutPoint>
	{
		...
		public bool Equals(OutPoint other) => TransactionId == other.Hash && Index == (int)other.N;
		public static bool operator ==(OutPoint x, TxoRef y) => y.TransactionId == x.Hash && y.Index == (int)x.N;
		public static bool operator ==(TxoRef x, OutPoint y) => y.Hash == x.TransactionId && (int)y.N == x.Index;
