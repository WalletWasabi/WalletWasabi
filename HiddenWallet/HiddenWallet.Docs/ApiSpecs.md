...
|POST /api/v1/wallet/build-transaction/{account} | Attempts to build a transaction with the specified wallet account | password, address, amount, feeType, allowUnconfirmed  | valid, failingReason, spendsUnconfirmed, fee, feePercentOfSent, hex, transaction |
