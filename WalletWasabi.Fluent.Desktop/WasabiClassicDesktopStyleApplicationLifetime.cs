...
public class WasabiClassicDesktopStyleApplicationLifetime : IClassicDesktopStyleApplicationLifetime, IDisposable
{
	...
	private static WasabiClassicDesktopStyleApplicationLifetime? ActiveLifetime;
	static WasabiClassicDesktopStyleApplicationLifetime()
	{
	...
	{
		ActiveLifetime?._windows.Remove((Window)sender!);
		ActiveLifetime?.HandleWindowClosed((Window)sender!);
	}

	private static void OnWindowOpened(object? sender, RoutedEventArgs e)
	{
		ActiveLifetime?._windows.Add((Window)sender!);
	}

#pragma warning disable CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
	public WasabiClassicDesktopStyleApplicationLifetime()
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
	...
	public int Start(string[] args, CancellationToken cancellationToken)
	{
...
public static class WasabiClassicDesktopStyleApplicationLifetimeExtensions
{
	public static int StartWithWasabiClassicDesktopLifetime<T>(
		this T builder, string[] args, ShutdownMode shutdownMode, CancellationToken cancellationToken)
		where T : AppBuilderBase<T>, new()
	{
		using WasabiClassicDesktopStyleApplicationLifetime lifetime = new()
		{
			Args = args,
		...
		return lifetime.Start(args, cancellationToken);
	}
}
